...
const Navbar = () => {
  ...
  return (
    <nav className='w-full bg-black text-white font-mono flex justify-between items-center py-4 px-6 tablet:px-10 laptop:px-12 relative'>
      ...
      <div className='tablet:hidden laptop:hidden relative z-50'>
        {menuOpen ? (
      ...
      {menuOpen && (
        <div className='absolute top-16 right-0 w-48 text-center bg-gray-700 rounded-lg flex flex-col items-center py-4 tablet:hidden laptop:hidden z-40'>
          ...
          <Link to="/contact" className='bg-gradient-to-r from-pink-500 to-fuchsia-500 transition-transform hover:scale-105 p-2 tablet:p-0 laptop:p-0 w-36 h-12 rounded-full justify-center items-center text-xl'>
            Contact Me
          </Link>
        </div>
      )}
